...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = RINEXApi()
        api_instance.list  # this is an instance of the class Endpoint
        api_instance.list()  # this invokes api_instance.list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.list.callable or self.callable in this class
