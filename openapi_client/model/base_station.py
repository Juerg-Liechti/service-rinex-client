...
class BaseStation(ModelNormal):
    ...
    attribute_map = {
        ...
        'active_from': 'active_from',  # noqa: E501
        'latitude': 'latitude',  # noqa: E501
        'longitude': 'longitude',  # noqa: E501
        'active_to': 'active_to',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, station_code, active_from, latitude, longitude, *args, **kwargs):  # noqa: E501
        """BaseStation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            active_to (str): If a datetime, the station stopped operation on this date. If \"now\", the station is still operational.. [optional]  # noqa: E501
        """
