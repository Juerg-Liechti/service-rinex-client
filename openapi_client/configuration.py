...
conf = openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.swipos-dev.ch/acacia" if host is None else host
        """Default Base url
        """
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.swipos-dev.ch/acacia",
                'description': "No description provided",
            },
            {
                'url': "https://api.swipos.ch/acacia",
                'description': "No description provided",
            }
        ]
